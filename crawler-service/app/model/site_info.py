...
class SiteInfo(Base):
    ...
    login_url = Column(String(1000), comment='WordPress 登录地址')
    wp_admin_user = Column(String(255), comment='WordPress 登录账户')
    wp_admin_user_pwd = Column(String(500), comment='WordPress 登录密码')
